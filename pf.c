...
static PFtabFindFname(char *fname)
		/* file name to find */
/****************************************************************************
SPECIFICATIONS:
...
PFreadfcn(int fd,int pagenum,PFfpage *buf)
	/* file descriptor */
 /* page number */
...
PFwritefcn(int fd,int pagenum,PFfpage *buf)
	/* file descriptor */
	/* page to read */
	/* buffer where to read the page */
/****************************************************************************
SPECIFICATIONS:
...
PF_GetFirstPage(int fd,int *pagenum,char **pagebuf)
	/* file descriptor */
	/* page number of first page */
	/* pointer to the pointer to buffer */
/****************************************************************************
SPECIFICATIONS:
...
PF_GetNextPage(int fd,int *pagenum,char **pagebuf)
	/* file descriptor of the file */
	/* old page number on input, new page number on output */
	/* pointer to pointer to buffer of page data */
/****************************************************************************
SPECIFICATIONS:
...
PF_GetThisPage(int fd,int pagenum,char **pagebuf)
		/* file descriptor */
	/* page number to read */
	/* pointer to pointer to page data */
/****************************************************************************
SPECIFICATIONS:
...
PF_AllocPage(int fd,int *pagenum,char **pagebuf)
		/* file descriptor */
/* page number */
	/* pointer to pointer to page buffer*/
/****************************************************************************
SPECIFICATIONS:
...
PF_DisposePage(int fd,int pagenum)
	/* file descriptor */
	/* page number */
/****************************************************************************
SPECIFICATIONS:
...
PF_UnfixPage(int fd,int pagenum,int dirty)
	/* file descriptor */
	/* page number */
