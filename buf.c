...
void PFbufUnlink(PFbpage *bpage)
		/* buffer page to be unlinked from the used list */
/****************************************************************************
SPECIFICATIONS:
...
static PFbufInternalAlloc(PFbpage **bpage,int (*writefcn)())
...
PFbufGet(int fd,int pagenum,PFfpage **fpage,int (*readfcn)(),int (*writefcn)())
	/* file descriptor */
	/* page number */
	/* pointer to pointer to file page */
...
PFbufUnfix(int fd,int pagenum,int dirty)
	/* file descriptor */
	/* page number */
...
PFbufAlloc(int fd,int pagenum,PFfpage **fpage,int (*writefcn)())
		/* file descriptor */
	/* page number */
	/* pointer to file page */
...
PFbufReleaseFile(int fd,int (*writefcn)())
		/* file descriptor */
	/* function to write a page of file */
/****************************************************************************
SPECIFICATIONS:
